    ...
    <LayoutSitePage
      ...
      <article>
                    ...
                    <div className="container">
                        <div>
                            <p>
                                Nawiązując współpracę ze mną, podpisując umowę, wysyłając zapytanie za pomocą formularza na stronie internetowej lub przez email, przekazujecie mi swoje dane osobowe,
                                których staję się administratorem i które jestem zobowiązany przetwarzać zgodnie z obowiązującym prawem. Dnia 25 maja 2018 roku w życie weszło rozporządzenie Parlamentu
                                Europejskiego 2016/679 z dnia 27 kwietnia 2016 roku nazwane RODO, które narzuca na wszystkich przedsiębiorców nowe prawa i obowiązki w związku z przetwarzaniem danych
                                osobowych.
                            </p>
                            <p>
                                Jako profesjonalny fotograf ślubny prowadzący legalnie swoją działalność gospodarczą na terenie Unii Europejskiej wprowadziłem szereg regulacji i zabezpieczeń, aby
                                Twoje dane były przechowywane zgodnie z regułami RODO. Wprowadziłem zasadę minimalizacji pobieranych danych przy jednoczesnym zabezpieczeniu ich najlepszymi dostępnymi
                                metodami.
                            </p>
                            <h2 className="quote-title">Kto jest administratorem Twoich danych osobowych?</h2>
                            <p>
                                Administratorem danych osobowych jest Tomasz Prokop - Fotograf Ślubny Kraków, 31-231 Kraków, ul. Bociana 4A/35. Kontakt w sprawach związanych z ochroną danych osobowych
                                możliwy jest za pośrednictwem adresu email:{" "}
                            ...
                            <p>
                                Otrzymałem je od Ciebie w różnych sytuacjach na przykład telefonicznie, przez email, gdy wypełniłeś formularz na mojej stronie internetowej, gdy wysłałeś do mnie
                                wiadomość z mediów społecznościowych lub podpisałeś ze mną umowę dotyczącą wykonania reportażu ślubnego lub sesji zdjęciowej.
                            </p>
                            ...
                            <p>
                                Twoje dane osobowe przechowywane są przez czas obowiązywania umowy zawartej z Tobą, a także w zależności od przeznaczenia w celach wykonania obowiązków wynikających z
                                przepisów prawa, w tym w szczególności podatkowych i rachunkowych, dochodzenie roszczeń oraz zapobieganie nadużyciom i oszustwom, maksymalnie 6 lat od dnia zakończenia
                                wykonania umowy.
                            </p>

                            <h2 className="quote-title">Jak zabezpieczam Twoje dane osobowe?</h2>
                            <p>
                                Dostęp do poczty, mediów społecznościowych, plików z danymi jest zabezpieczony hasłem i ograniczony tylko do dwóch urządzeń w mojej firmie. Dyski twarde, na których
                                przechowuję fotografie są zabezpieczone przed dostępem fizycznym. Archiwa fotografii są zanonimizowane, skatalogowane i każda sesja zabezpieczona jest hasłem dostępu.
                            </p>
                        </div>
                    </div>
